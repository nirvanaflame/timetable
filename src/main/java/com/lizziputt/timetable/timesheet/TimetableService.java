...
public class TimetableService extends CrudService<Timesheet> {
    ...
    public TimetableService(CrudRepository<Timesheet, Integer> crudRepository, SubjectService subjectService, ClassroomService classroomService, StudentService studentService, TeacherService teacherService) {
    ...
    public void createTimetable(Scanner scan) {
    ...
    public void updateTimetable(Timesheet timesheet) {
